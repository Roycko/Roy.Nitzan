from flask import Blueprint, render_template,render_template,request,session,redirect,url_for,Flask

# assignment9 blueprint definition
assignment9 = Blueprint('assignment9', __name__, static_folder='static', static_url_path='/assignment9', template_folder='templates')


# Routes
@assignment9.route('/assignment9', methods= ['GET','POST'])
def ass9_func():
